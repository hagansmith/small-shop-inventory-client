        ...
        return (
             ...
             //    details.active ?
                <Table.Row key={details.key}>
                    ...
                    <Table.Cell><h4 className="Title">{details.first_name} {details.last_name}</h4></Table.Cell>
                    <Table.Cell textAlign='center'><h4 className="ordersCount">{details.orders_count}</h4></Table.Cell>
                    <Table.Cell textAlign='center'><h4 className="Address">{details.total_spent}</h4></Table.Cell>
                    <Table.Cell textAlign='center'><h4 className="City">{details.city}</h4></Table.Cell>
                    <Table.Cell textAlign='center'><h4 className="State">{details.province}</h4></Table.Cell>
                    <Table.Cell textAlign='center'><h4 className="Zip">{details.zip}</h4></Table.Cell>
